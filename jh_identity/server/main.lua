...
RegisterServerEvent('Jh_identity:setIdentity')
AddEventHandler('Jh_identity:setIdentity', function(data, myIdentifiers)
	setIdentity(myIdentifiers.steamid, data, function(callback)
		if callback then
			TriggerClientEvent('Jh_identity:identityCheck', myIdentifiers.playerid, true)
		else
...
AddEventHandler('es:playerLoaded', function(source)
	...
	TriggerClientEvent('Jh_identity:saveID', source, myID)
	getIdentity(source, function(data)
		if data.firstname == '' then
			TriggerClientEvent('Jh_identity:identityCheck', source, false)
			TriggerClientEvent('Jh_identity:showRegisterIdentity', source)
		else
			TriggerClientEvent('Jh_identity:identityCheck', source, true)
		end
	end)
end)
...
AddEventHandler('onResourceStart', function(resource)
	if resource == GetCurrentResourceName() then
		...
		for i=1, #xPlayers, 1 do
			...
			TriggerClientEvent('Jh_identity:saveID', xPlayer.source, myID)

			getIdentity(xPlayer.source, function(data)
				if data.firstname == '' then
					TriggerClientEvent('Jh_identity:identityCheck', xPlayer.source, false)
					TriggerClientEvent('Jh_identity:showRegisterIdentity', xPlayer.source)
				else
					TriggerClientEvent('Jh_identity:identityCheck', xPlayer.source, true)
				end
			end)
		end
	end
...
RegisterCommand('resetchar', function(source, args, rawCommand)
    ...
    if xPlayer.getGroup() ~= "user" then
        if args[1] ~= nil then
            ...
            TriggerClientEvent("ot-notify:notify", source, "", "Einreise Amt", "Du hast eine Person ihr Visum auffrischen lassen!")
            TriggerClientEvent("ot-notify:notify", targetPlayer.source, "", "Einreise Amt", "Dein Visum wurde von ".. GetPlayerName(source) .. " aufgefrischt!")
            TriggerClientEvent('Jh_identity:showRegisterIdentity', targetPlayer.source)
        else
            TriggerClientEvent("ot-notify:notify", source, "", "Einreise Amt", "/resetchar id")
        end
    end
end, false)
...
--[[TriggerEvent('es:addGroupCommand', 'resetchar', 'guide', function(source, args, user)
    ...
    TriggerClientEvent("ot-notify:notify", source, "", "Einreise Amt", "Du hast eine Person ihr Visum auffrischen lassen!")
    TriggerClientEvent("ot-notify:notify", source, "", "Einreise Amt", "Dein Visum wurde von ".. GetPlayerName(source) .. " aufgefrischt!")
    TriggerClientEvent('Jh_identity:showRegisterIdentity', targetPlayer.source)
end)]]
